...
const FAQ = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Orci dictumst nec aliquet id ullamcorper venenatis. Fermentum sulla craspor.",
    },
    {
      question: "Augue in nibh urna volutpat mattis?",
      answer:
        "Elit adipiscing proin quis est consectetur felis ultricies nisi quis malesuada.",
    },
    {
